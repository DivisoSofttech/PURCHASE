...
import com.diviso.purchase.repository.CommentRepository;
import com.diviso.purchase.service.CommentService;
import com.diviso.purchase.service.dto.CommentDTO;
import com.diviso.purchase.service.mapper.CommentMapper;
...
public class CommentResourceIntTest {
    ...
    public void createComment() throws Exception {
        ...
        assertThat(testComment.getReference()).isEqualTo(DEFAULT_REFERENCE);
    ...
    public void updateComment() throws Exception {
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getReference()).isEqualTo(UPDATED_REFERENCE);
