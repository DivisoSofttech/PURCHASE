...
import com.diviso.purchase.repository.StatusRepository;
import com.diviso.purchase.service.StatusService;
import com.diviso.purchase.service.dto.StatusDTO;
import com.diviso.purchase.service.mapper.StatusMapper;
...
public class StatusResourceIntTest {
    ...
    public void createStatus() throws Exception {
        ...
        assertThat(testStatus.getStatusLevel()).isEqualTo(DEFAULT_STATUS_LEVEL);
    }
    ...
    public void updateStatus() throws Exception {
        ...
        assertThat(testStatus.getStatusLevel()).isEqualTo(UPDATED_STATUS_LEVEL);
    }
