...
public class RatingResourceIntTest {
    ...
    public void createRating() throws Exception {
        ...
        assertThat(testRating.getReference()).isEqualTo(DEFAULT_REFERENCE);
        assertThat(testRating.getRatings()).isEqualTo(DEFAULT_RATINGS);
    }
    ...
    public void updateRating() throws Exception {
        ...
        Rating testRating = ratingList.get(ratingList.size() - 1);
        assertThat(testRating.getReference()).isEqualTo(UPDATED_REFERENCE);
        assertThat(testRating.getRatings()).isEqualTo(UPDATED_RATINGS);
    }
